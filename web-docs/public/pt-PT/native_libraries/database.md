# Módulo de Base de Dados em Aly

Aly fornece drivers de base de dados integrados para SQLite, PostgreSQL, MySQL e Redis através do módulo `db`.
...
O módulo de base de dados suporta pool de ligações através do sistema `registry`, permitindo a reutilização de ligações à base de dados entre pedidos.
