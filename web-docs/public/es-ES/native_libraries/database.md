# Módulo de Base de Datos en Aly

Aly proporciona controladores de base de datos integrados para SQLite, PostgreSQL, MySQL y Redis a través del módulo `db`.
...
El módulo de base de datos admite la agrupación de conexiones a través del sistema `registry`, permitiendo la reutilización de conexiones de base de datos entre solicitudes.