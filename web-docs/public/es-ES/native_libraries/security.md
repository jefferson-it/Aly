# Módulo de Seguridad en Aly

El módulo `security` proporciona JWT, OAuth2, OpenID Connect, TLS, hashing, firmas digitales, ACME (Let's Encrypt) y sanitización de entradas.
...
# Obtiene e instala automáticamente el certificado TLS
```
...
print(clean)  # Elimina o escapea el HTML peligroso

let safe = security.sanitize.sql("Robert'; DROP TABLE Students;--")
print(safe)  # Escapea intentos de inyección SQL
```